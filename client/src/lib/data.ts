...
export const MOCK_BOARD = {
  notes: [
    { id: 1, title: "Kitchen Renovation Ideas", content: "Open shelving, quartz countertops, brass hardware." },
    { id: 2, title: "Questions for Seller", content: "Age of roof? HVAC maintenance history?" }
  ],
  tasks: [
    { id: 1, title: "Submit Pre-approval", status: "Done", date: "Oct 15" },
    { id: 2, title: "Schedule Inspection", status: "In Progress", date: "Oct 20" },
    { id: 3, title: "Review HOA Documents", status: "To Do", date: "Oct 25" }
  ],
  documents: [
    { id: 1, title: "Pre-Approval Letter.pdf", type: "pdf", date: "Oct 10" },
    { id: 2, title: "Purchase Agreement.pdf", type: "pdf", date: "Oct 18" },
    { id: 3, title: "Property Disclosure.pdf", type: "pdf", date: "Oct 12" }
  ]
};